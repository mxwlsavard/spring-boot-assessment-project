...
public class InvoiceController {
    ...
    would be to return (a list of) the entire invoice entities from a /customers/{id}/invoices endpoint and leave it up to the client
    to parse the tender field. If you really wanted you could let the client filter out fields it doesn't need by doing
